...
import { createAddress, getAllAddresses } from "../api/index";
                ...
                >
                    ...
                    <Box component="form" noValidate sx={{ mt: 3 }}>
                                ...
                                <FormControlLabel
                                    control={
                                        <Checkbox color="primary"
                                            ...
                                            onChange={(e) => setEditBillingAddress(!editBillingAddress)} />}
                        ...
                        <Button
                            ...
                            onClick={(e) => {
                                e.preventDefault()
                                createAddress(editName, editStreet1, editStreet2, editCity, editState, editPostalCode, editCountry, editBillingAddress);
                            }}
                        >Update</Button>
                    </Box>
                </Box>
