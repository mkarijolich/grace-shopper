...
const Featured = ( { productsArray, generalViewOn, setGeneralViewOn, productBeingViewed, setProductBeingViewed } ) => {
    ...
    const productCards = featuredProductsArray.map((product) => {
    ...
    //     return <div class="product-specific-view">
    //     <h4 class="product-name">{productBeingViewed.name}</h4>
    //     <p class="product-price">{productBeingViewed.price}</p>
    //     {allProductPictures}
    //     <Button variant="contained" onClick={(event) => handleClickView(productBeingViewed)}>Back</Button>
    // </div>
    //     } else {
    //         return <div class="product-specific-view">
    //         <h4 class="product-name">{productBeingViewed.name}</h4>
